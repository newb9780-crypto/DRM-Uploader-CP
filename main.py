...
credit ="😎𝖘:)™~" 
OWNER = int(os.environ.get("OWNER", 1394117837))
try: 
    ADMINS=[] 
    for x in (os.environ.get("ADMINS", "1394117837").split()):  
        ADMINS.append(int(x)) 
except ValueError: 
...
bot = Client("bot",    
   bot_token="8748256101:AAE5gox8iWkb0Q0D4bzv9NuOpT12vs5LNdo",    
   api_id= 35524250,    
   api_hash= "98de9f02ef055387a1cf3eda6220a18e"
)
